...
```javascript
cosqi = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/fft-base-fftpack-cosqi@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var cosqi = require( 'path/to/vendor/umd/fft-base-fftpack-cosqi/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/fft-base-fftpack-cosqi@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/fft-base-fftpack-cosqi.svg
[npm-url]: https://npmjs.org/package/@stdlib/fft-base-fftpack-cosqi

[test-image]: https://github.com/stdlib-js/fft-base-fftpack-cosqi/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/fft-base-fftpack-cosqi/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/fft-base-fftpack-cosqi/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/fft-base-fftpack-cosqi?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/fft-base-fftpack-cosqi.svg
[dependencies-url]: https://david-dm.org/stdlib-js/fft-base-fftpack-cosqi/main
...
[deno-url]: https://github.com/stdlib-js/fft-base-fftpack-cosqi/tree/deno
[deno-readme]: https://github.com/stdlib-js/fft-base-fftpack-cosqi/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/fft-base-fftpack-cosqi/tree/umd
[umd-readme]: https://github.com/stdlib-js/fft-base-fftpack-cosqi/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/fft-base-fftpack-cosqi/tree/esm
[esm-readme]: https://github.com/stdlib-js/fft-base-fftpack-cosqi/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/fft-base-fftpack-cosqi/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/fft-base-fftpack-cosqi/main/LICENSE
